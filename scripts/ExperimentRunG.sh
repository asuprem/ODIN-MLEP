        ...
        do
            ...
            do
                ...
                do
                    ...
                    echo "python application.py ${expName} --update ${updateVal} --weights ${weightVal} --select ${selectVal} --filter ${filterVal} --kval ${kvalVal} >> ${experimentOutputLogfile} 2>&1" >> $experimentOutputLogfile 2>&1
                    ...
                    _litmus_/bin/python application.py ${expName} --update ${updateVal} --weights ${weightVal} --select ${selectVal} --filter ${filterVal} --kval ${kvalVal} >> ${experimentOutputLogfile} 2>&1
                done
            done
        done
    done
